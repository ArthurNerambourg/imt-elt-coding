...
def extract_orders() -> pd.DataFrame:
    ...
    try:
        ...
        logger.error(f"Erreur lors de l'extraction des commandes: {e}")
        raise
...
def extract_order_line_items() -> pd.DataFrame:
    ...
    try:
        ...
        logger.error(f"Erreur lors de l'extraction des articles de commande: {e}")
        raise
...
def extract_clickstream() -> pd.DataFrame:
    ...
    try:
        ...
        logger.error(f"Erreur lors de l'extraction du clickstream: {e}")
        raise
